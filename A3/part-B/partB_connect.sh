...
# r1 to s1
$ofctl add-flow r1 \
    in_port=1,ip,nw_src=10.1.1.17,nw_dst=10.6.6.69,actions=mod_dl_src:0A:00:0E:FE:00:02,mod_dl_dst:0A:00:04:01:00:01,output=2
...
# r2 to s2
$ofctl add-flow r2 \
    in_port=1,ip,nw_src=10.1.1.17,nw_dst=10.6.6.69,actions=mod_dl_src:0A:00:10:FE:00:02,mod_dl_dst:0A:00:02:02:00:00,output=2
...
# r2 to s1
$ofctl add-flow r2 \
    in_port=2,ip,nw_src=10.6.6.69,nw_dst=10.1.1.17,actions=mod_dl_src:0A:00:05:01:00:01,mod_dl_dst:0A:00:0E:FE:00:02,output=1
...
# r1 to s0
$ofctl add-flow r1 \
    in_port=2,ip,nw_src=10.6.6.69,nw_dst=10.1.1.17,actions=mod_dl_src:0A:00:04:01:00:01,mod_dl_dst:0A:00:00:02:00:00,output=1
